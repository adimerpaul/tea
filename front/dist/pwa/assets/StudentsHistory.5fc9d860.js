...
</table>`}}const he={name:"StudentsDocuments",props:{student_id:{type:Number,required:!0},student:{type:Object,required:!0}},data(){return{loading:!1,qeditor:"",fonts:{arial:"Arial",arial_black:"Arial Black",comic_sans:"Comic Sans MS",courier_new:"Courier New",impact:"Impact",lucida_grande:"Lucida Grande",times_new_roman:"Times New Roman",verdana:"Verdana"},toolbar:[[{label:this.$q.lang.editor.align,icon:this.$q.iconSet.editor.align,fixedLabel:!0,list:"only-icons",options:["left","center","right","justify"]},{label:this.$q.lang.editor.align,icon:this.$q.iconSet.editor.align,fixedLabel:!0,options:["left","center","right","justify"]}],["bold","italic","strike","underline","subscript","superscript"],["token","hr","link","custom_btn"],["print","fullscreen"],[{label:this.$q.lang.editor.formatting,icon:this.$q.iconSet.editor.formatting,list:"no-icons",options:["p","h1","h2","h3","h4","h5","h6","code"]},{label:this.$q.lang.editor.fontSize,icon:this.$q.iconSet.editor.fontSize,fixedLabel:!0,fixedIcon:!0,list:"no-icons",options:["size-1","size-2","size-3","size-4","size-5","size-6","size-7"]},{label:this.$q.lang.editor.defaultFont,icon:this.$q.iconSet.editor.font,fixedIcon:!0,list:"no-icons",options:["default_font","arial","arial_black","comic_sans","courier_new","impact","lucida_grande","times_new_roman","verdana"]},"removeFormat"],["quote","unordered","ordered","outdent","indent"],["undo","redo"],["viewsource"]],documentsSelect:["AUTORIZACI\xD3N PARA EL ABORDAJE DEC.","CERTIFICADO PARA EL EMPLEADOR","CONTRATO DE CONTIGENCIAS","FICHA DEL PLAN DE APOYO INDIVIDUALIZADO (PAI) PARA ESTUDIANTES CON TEA","PLAN DE ACOMPA\xD1AMIENTO EMOCIONAL Y CONDUCTUAL","FICHA DE SEGUIMIENTO INDIVIDUALIZADA PARA DESREGULACI\xD3N EMOCIONAL"],documentDialog:!1,documentDialogPdf:!1,iframe:!1,document:{},documents:[]}},mounted(){this.documentsGet()},methods:{restoreHtml(){const e=ct().format("DD/MM/YYYY HH:mm:ss");if(this.document.name==="AUTORIZACI\xD3N PARA EL ABORDAJE DEC."&&(this.document.html=F.autorizacionAbordajeDec(this.student.tutorName,this.student.tutorRut,this.student.name,this.student.course)),this.document.name==="CERTIFICADO PARA EL EMPLEADOR"&&(this.document.html=F.certificadoEmpleador(this.student.name,this.student.tutorName,this.student.course,this.student.tutorRut)),this.document.name==="CONTRATO DE CONTIGENCIAS"&&(this.document.html=F.contratoContigencia(this.student.name,this.student.tutorName,"",e)),this.document.name==="FICHA DEL PLAN DE APOYO INDIVIDUALIZADO (PAI) PARA ESTUDIANTES CON TEA"&&(this.document.html=F.fichaPai(this.student.name,this.student.course,this.student.birthdate,e)),this.document.name==="PLAN DE ACOMPA\xD1AMIENTO EMOCIONAL Y CONDUCTUAL"){let t=0;this.student.birthdate&&(t=ct().diff(this.student.birthdate,"years")),this.document.html=F.planAcompanamiento(this.student.name,this.student.rut,t,this.student.course,this.student.tutorName,this.student.phone)}this.document.name==="FICHA DE SEGUIMIENTO INDIVIDUALIZADA PARA DESREGULACI\xD3N EMOCIONAL"&&(this.document.html=F.fichaSeguimiento(this.student.name,e))},documentShowMobile(e){window.open(this.$url+"documents/"+e.codigo+"/show","_blank")},documentShow(e){this.loading=!0,this.$axios.get(`documents/${e.id}/download64`).then(t=>{this.document=t.data,this.documentDialogPdf=!0,this.iframe=`data:application/pdf;base64,${this.document.pdf}`}).catch(t=>{this.$alert.error(t.response.data.message)}).finally(()=>{this.loading=!1})},documentClickEdit(e){this.document=e,this.documentDialog=!0},documentDelete(e){this.$alert.confirm("\xBFEst\xE1 seguro de eliminar este document?").onOk(()=>{this.loading=!0,this.$axios.delete(`documents/${e.id}`).then(t=>{this.$alert.success("Documento eliminado"),this.documentsGet()}).catch(t=>{this.$alert.error(t.response.data.message)}).finally(()=>{this.loading=!1})})},documentOpen(e){this.loading=!0,this.$axios.get(`documents/${e.id}/download`,{responseType:"blob"}).then(t=>{const i=window.URL.createObjectURL(new Blob([t.data],{type:"application/pdf"})),n=window.document.createElement("a");n.href=i,n.setAttribute("download",`${e.description}.pdf`),window.document.body.appendChild(n),n.click(),n.remove(),window.URL.revokeObjectURL(i)}).catch(t=>{this.$alert.error(t.response.data.message)}).finally(()=>{this.loading=!1})},documentsGet(){this.loading=!0,this.$axios.get("documents",{params:{student_id:this.student_id}}).then(e=>{this.documents=e.data}).catch(e=>{this.$alert.error(e.response.data.message)}).finally(()=>{this.loading=!1})},documentCreate(){this.loading=!0,this.$axios.post("documents",{student_id:this.student_id,document:this.document}).then(e=>{this.$alert.success("Documento agregado"),this.documentDialog=!1,this.documentsGet()}).catch(e=>{this.$alert.error(e.response.data.message)}).finally(()=>{this.loading=!1})},documentUpdate(){this.loading=!0,this.$axios.put(`documents/${this.document.id}`,this.document).then(e=>{this.$alert.success("Documento actualizado"),this.documentDialog=!1,this.documentsGet()}).catch(e=>{this.$alert.error(e.response.data.message)}).finally(()=>{this.loading=!1})},documentForm(){this.document.id?this.documentUpdate():this.documentCreate()},addDocument(){this.documentDialog=!0,this.document={html:""}}}},be={class:"row items-center"},ye=s("div",{class:"text-h6 text-bold"},"Documentos",-1),ve=s("thead",null,[s("tr",null,[s("th",null,"Opciones"),s("th",null,"Fecha"),s("th",null,"Documento"),s("th",null,"Usuario")])],-1),Ce={class:"text-h6 text-bold"},ze={class:"row"},we={class:"col-12"},xe=s("div",{class:"text-h6 text-bold"},"Documento",-1),Le={class:"row"},Ee={class:"col-12"},ke=["src"];function Ae(e,t,i,n,a,m){return h(),w(q,null,{default:p(()=>[l(E,null,{default:p(()=>[s("div",be,[ye,l(H),l(z,{icon:"add_circle_outline",onClick:m.addDocument,label:"Agregar","no-caps":"",color:"indigo",dense:"",size:"10px",loading:a.loading},null,8,["onClick","loading"])]),l(ft,{dense:"","wrap-cells":""},{default:p(()=>[ve,s("tbody",null,[(h(!0),M(et,null,tt(a.documents,d=>{var c;return h(),M("tr",{key:d.id},[s("td",null,[l(nt,{size:"10px",color:"primary",loading:a.loading,"auto-close":"",class:"q-mr-sm",label:"Opciones","no-caps":""},{default:p(()=>[N((h(),w(j,{clickable:"",onClick:v=>m.documentOpen(d)},{default:p(()=>[l(b,{avatar:""},{default:p(()=>[l(S,{name:"fa-solid fa-file-arrow-down"})]),_:1}),l(b,null,{default:p(()=>[D("Descargar")]),_:1})]),_:2},1032,["onClick"])),[[R]]),N((h(),w(j,{clickable:"",onClick:v=>m.documentShow(d)},{default:p(()=>[l(b,{avatar:""},{default:p(()=>[l(S,{name:"fa-solid fa-eye"})]),_:1}),l(b,null,{default:p(()=>[D("Ver")]),_:1})]),_:2},1032,["onClick"])),[[R]]),N((h(),w(j,{clickable:"",onClick:v=>m.documentDelete(d)},{default:p(()=>[l(b,{avatar:""},{default:p(()=>[l(S,{name:"delete"})]),_:1}),l(b,null,{default:p(()=>[D("Eliminar")]),_:1})]),_:2},1032,["onClick"])),[[R]]),N((h(),w(j,{clickable:"",onClick:v=>m.documentClickEdit(d)},{default:p(()=>[l(b,{avatar:""},{default:p(()=>[l(S,{name:"edit"})]),_:1}),l(b,null,{default:p(()=>[D("Editar")]),_:1})]),_:2},1032,["onClick"])),[[R]])]),_:2},1032,["loading"])]),s("td",null,u(e.$filters.formatdMYHMS(d.date)),1),s("td",null,u(d.description),1),s("td",null,u((c=d.user)==null?void 0:c.name),1)])}),128))])]),_:1})]),_:1}),l(at,{modelValue:a.documentDialog,"onUpdate:modelValue":t[4]||(t[4]=d=>a.documentDialog=d),persistent:""},{default:p(()=>[l(q,{style:{width:"750px","max-width":"90vw",height:"90vh","max-height":"90vh"}},{default:p(()=>[l(E,{class:"row items-center q-pb-none"},{default:p(()=>[s("div",Ce,u(a.document.id?"Editar":"Agregar")+" Documento ",1),l(H),l(z,{icon:"close",flat:"",round:"",dense:"",onClick:t[0]||(t[0]=d=>a.documentDialog=!1)})]),_:1}),l(E,null,{default:p(()=>[l(oe,{modelValue:a.document.name,"onUpdate:modelValue":[t[1]||(t[1]=d=>a.document.name=d),m.restoreHtml],options:a.documentsSelect,label:"Seleccionar Documento",outlined:"",dense:""},null,8,["modelValue","options","onUpdate:modelValue"]),l(ht,{onSubmit:m.documentForm},{default:p(()=>[s("div",ze,[s("div",we,[a.document.html!==""?(h(),w(fe,{key:0,modelValue:a.document.html,"onUpdate:modelValue":t[2]||(t[2]=d=>a.document.html=d),dense:e.$q.screen.lt.md,toolbar:a.toolbar,fonts:a.fonts},null,8,["modelValue","dense","toolbar","fonts"])):it("",!0)])]),l(ut,{align:"right"},{default:p(()=>[l(z,{label:"Cancelar",color:"negative",onClick:t[3]||(t[3]=d=>a.documentDialog=!1),loading:a.loading,icon:"close","no-caps":""},null,8,["loading"]),a.document.html!==""?(h(),w(z,{key:0,label:a.document.id?"Editar":"Agregar",color:a.document.id?"orange":"green",type:"submit",loading:a.loading,icon:a.document.id?"edit":"save","no-caps":""},null,8,["label","color","loading","icon"])):it("",!0)]),_:1})]),_:1},8,["onSubmit"])]),_:1})]),_:1})]),_:1},8,["modelValue"]),l(at,{modelValue:a.documentDialogPdf,"onUpdate:modelValue":t[6]||(t[6]=d=>a.documentDialogPdf=d)},{default:p(()=>[l(q,{style:{width:"750px","max-width":"90vw"}},{default:p(()=>[l(E,{class:"row items-center q-pb-none"},{default:p(()=>[xe,l(H),l(z,{icon:"close",flat:"",round:"",dense:"",onClick:t[5]||(t[5]=d=>a.documentDialogPdf=!1)})]),_:1}),l(E,null,{default:p(()=>[s("div",Le,[s("div",Ee,[s("iframe",{src:a.iframe,width:"100%",height:"500px"},null,8,ke)])])]),_:1})]),_:1})]),_:1},8,["modelValue"])]),_:1})}var De=gt(he,[["render",Ae]]);const je={name:"StudentsHistory",components:{StudentsDocuments:De},data(){return{student_id:this.$route.params.id,student:{},process:0,textProcess:"",loading:!1,historyDialog:!1,history:{description:""}}},mounted(){this.student_id=this.$route.params.id,this.studentGet()},methods:{deleteHistory(e){this.$alert.confirm("\xBFEst\xE1 seguro de eliminar este historial?").onOk(()=>{this.loading=!0,this.$axios.delete(`history/${e}`).then(t=>{const i=this.student.histories.findIndex(n=>n.id===e);this.student.histories.splice(i,1)}).catch(t=>{this.$alert.error(t.response.data.message)}).finally(()=>{this.loading=!1})})},sendWhatsapp(e){window.open(`https://api.whatsapp.com/send?phone=+56${this.student.phone}&text=${e.description}`)},historyClick(e){this.history={...e},this.historyDialog=!0},historyForm(){this.loading=!0,this.history.student_id=this.student_id,this.history.id?this.$axios.put(`history/${this.history.id}`,this.history).then(e=>{const t=this.student.histories.findIndex(i=>i.id===this.history.id);this.student.histories.splice(t,1,e.data),this.historyDialog=!1}).catch(e=>{this.$alert.error(e.response.data.message)}).finally(()=>{this.loading=!1}):this.$axios.post("history",this.history).then(e=>{this.student.histories.unshift(e.data),this.historyDialog=!1}).catch(e=>{this.$alert.error(e.response.data.message)}).finally(()=>{this.loading=!1})},addHistory(){this.historyDialog=!0,this.history.id=void 0,this.history.description=""},handleDrop(e){e.preventDefault();const t=e.dataTransfer.files;this.processFiles(t)},processFiles(e){this.fileUpload(e)},uploadFile(){this.$q.dialog({title:"Ingrese rut del estudiante",message:"Ingrese el rut del estudiante para subir el diagn\xF3stico",prompt:{model:"",type:"text",required:!0,rules:[e=>!!e||"Campo requerido"]},cancel:!0,persistent:!0}).onOk(e=>{this.$refs.fileInput.click()})},fileUpload(){const e=new FormData;e.append("file",this.$refs.fileInput.files[0]),e.append("student_id",this.student_id);const t={onUploadProgress:i=>{const n=Math.round(i.loaded*100/i.total);this.textProcess=n+"% completado",this.process=n/100}};this.$axios.post(`students/${this.student_id}/diagnoses`,e,t).then(i=>{this.student.diagnoses.unshift(i.data)}).catch(i=>{this.$alert.error(i.response.data.message)}).finally(()=>{this.$refs.fileInput.value="",this.textProcess=""})},studentGet(){this.$axios.get(`students/${this.student_id}`).then(e=>{this.student=e.data}).catch(e=>{this.$alert.error(e.response.data.message)})},downloadFile(e){this.loading=!0,this.$axios.get(`diagnoses/${e.id}/download`,{responseType:"blob"}).then(t=>{const i=window.URL.createObjectURL(new Blob([t.data],{type:t.headers["content-type"]})),n=document.createElement("a");n.href=i,n.setAttribute("download",e.name),document.body.appendChild(n),n.click(),n.remove(),window.URL.revokeObjectURL(i)}).catch(t=>{this.$alert.error(t.response.data.message)}).finally(()=>{this.loading=!1})},deleteDiagnosis(e){this.$alert.confirm("\xBFEst\xE1 seguro de eliminar este diagn\xF3stico?").onOk(()=>{this.loading=!0,this.$axios.delete(`diagnoses/${e}`).then(t=>{const i=this.student.diagnoses.findIndex(n=>n.id===e);this.student.diagnoses.splice(i,1)}).catch(t=>{this.$alert.error(t.response.data.message)}).finally(()=>{this.loading=!1})})}}},Ie={class:"row"},qe={class:"col-12"},Se={class:"row"},Oe={class:"col-12 col-md-8"},Pe={class:"row"},Te={class:"col-6 col-md-4"},Ne=s("label",{class:"text-bold"},"Rut",-1),Re={class:"col-6 col-md-8"},Fe=s("label",{class:"text-bold"},"Nombre Completo",-1),$e={class:"col-6 col-md-4"},Ue=s("label",{class:"text-bold"},"Rut Tutor",-1),Me={class:"col-6 col-md-8"},He=s("label",{class:"text-bold"},"Nombre Tutor",-1),Be={class:"col-12 col-md-4"},Qe=s("div",{class:"text-bold"},"Fotografia",-1),Ge={class:"flex flex-center"},Je={class:"col-6 col-md-3"},Ye=s("label",{class:"text-bold"},"Fecha de Nacimiento",-1),Ze={class:"col-6 col-md-3"},Ke=s("label",{class:"text-bold"},"A\xF1o ingreso PIE",-1),Ve={class:"col-6 col-md-3"},We=s("label",{class:"text-bold"},"Curso",-1),Xe={class:"col-6 col-md-3"},ti=s("label",{class:"text-bold"},"A\xF1o",-1),ei={class:"col-12"},ii=s("label",{class:"text-bold"},"Direcci\xF3n",-1),ai={class:"col-6 col-md-3"},ni=s("label",{class:"text-bold"},"Celular",-1),oi={class:"col-6 col-md-3"},si=s("label",{class:"text-bold"},"email",-1),ri={class:"col-6 col-md-3"},li=s("label",{class:"text-bold"},"Sexo",-1),pi={class:"row"},di={class:"col-12 col-md-8"},ci={class:"row"},mi={class:"col-12"},_i={class:"row items-center"},gi=s("div",{class:"text-h6 text-bold"},"Antecedentes",-1),ui=s("thead",null,[s("tr",null,[s("th",null,"Opciones"),s("th",null,"Fecha"),s("th",null,"Descripci\xF3n"),s("th",null,"Usuario")])],-1),fi={class:"col-12"},hi={class:"col-12 col-md-4"},bi=s("div",{class:"text-h6"},"Diagn\xF3sticos",-1),yi=s("div",null,"Ac\xE1 suba sus archivos",-1),vi={class:"q-mt-md"},Ci={class:"text-h6 text-bold"};function zi(e,t,i,n,a,m){const d=Xt("StudentsDocuments");return h(),w(se,{class:"bg-grey-3 q-pa-md"},{default:p(()=>[l(q,{class:"q-mb-md"},{default:p(()=>[l(E,null,{default:p(()=>[s("div",Ie,[s("div",qe,[s("div",Se,[s("div",Oe,[s("div",Pe,[s("div",Te,[Ne,s("div",null,u(a.student.rut),1)]),s("div",Re,[Fe,s("div",null,u(a.student.name),1)]),s("div",$e,[Ue,s("div",null,u(a.student.tutorRut),1)]),s("div",Me,[He,s("div",null,u(a.student.tutorName),1)])])]),s("div",Be,[Qe,s("div",Ge,[l(Ft,{src:e.$url+"../students/"+a.student.foto,style:{width:"100px",height:"100px"}},null,8,["src"])])])])]),s("div",Je,[Ye,s("div",null,u(a.student.birthdate),1)]),s("div",Ze,[Ke,s("div",null,u(a.student.year_PIE),1)]),s("div",Ve,[We,s("div",null,u(a.student.course),1)]),s("div",Xe,[ti,s("div",null,u(a.student.year),1)]),s("div",ei,[ii,s("div",null,u(a.student.address),1)]),s("div",ai,[ni,s("div",null,u(a.student.phone),1)]),s("div",oi,[si,s("div",null,u(a.student.email),1)]),s("div",ri,[li,s("div",null,u(a.student.sex==="M"?"Masculino":"Femenino"),1)])])]),_:1})]),_:1}),s("div",pi,[s("div",di,[s("div",ci,[s("div",mi,[l(q,null,{default:p(()=>[l(E,null,{default:p(()=>[s("div",_i,[gi,l(H),l(z,{icon:"add_circle_outline",onClick:m.addHistory,label:"Agregar registro","no-caps":"",color:"green",dense:"",size:"10px"},null,8,["onClick"])]),l(ft,{dense:"","wrap-cells":""},{default:p(()=>[ui,s("tbody",null,[(h(!0),M(et,null,tt(a.student.histories,c=>{var v;return h(),M("tr",{key:c.id},[s("td",null,[l(nt,{size:"10px",color:"positive",loading:a.loading,"auto-close":"",class:"q-mr-sm",label:"Opciones","no-caps":""},{default:p(()=>[N((h(),w(j,{clickable:"",onClick:L=>m.deleteHistory(c)},{default:p(()=>[l(b,{avatar:""},{default:p(()=>[l(S,{name:"delete"})]),_:1}),l(b,null,{default:p(()=>[D("Eliminar")]),_:1})]),_:2},1032,["onClick"])),[[R]]),N((h(),w(j,{clickable:"",onClick:L=>m.historyClick(c)},{default:p(()=>[l(b,{avatar:""},{default:p(()=>[l(S,{name:"edit"})]),_:1}),l(b,null,{default:p(()=>[D("Editar")]),_:1})]),_:2},1032,["onClick"])),[[R]]),N((h(),w(j,{clickable:"",onClick:L=>m.sendWhatsapp(c)},{default:p(()=>[l(b,{avatar:""},{default:p(()=>[l(S,{name:"send"})]),_:1}),l(b,null,{default:p(()=>[D("Enviar por Whatsapp")]),_:1})]),_:2},1032,["onClick"])),[[R]])]),_:2},1032,["loading"])]),s("td",null,u(e.$filters.formatdMYHMS(c.created_at)),1),s("td",null,u(c.description),1),s("td",null,u((v=c.user)==null?void 0:v.name),1)])}),128))])]),_:1})]),_:1})]),_:1})]),s("div",fi,[l(d,{student_id:parseInt(a.student_id),student:a.student},null,8,["student_id","student"])])])]),s("div",hi,[l(q,null,{default:p(()=>[l(E,null,{default:p(()=>[bi,s("div",{class:"text-center border-dashed cursor-pointer",onClick:t[0]||(t[0]=(...c)=>m.uploadFile&&m.uploadFile(...c)),onDragenter:t[1]||(t[1]=J(()=>{},["prevent"])),onDragover:t[2]||(t[2]=J(()=>{},["prevent"])),onDragleave:t[3]||(t[3]=J(()=>{},["prevent"])),onDrop:t[4]||(t[4]=J((...c)=>m.handleDrop&&m.handleDrop(...c),["prevent"]))},[l(S,{name:"cloud_upload",size:"70px"}),yi],32),s("input",{type:"file",class:"hidden",ref:"fileInput",onChange:t[5]||(t[5]=(...c)=>m.fileUpload&&m.fileUpload(...c)),accept:".pdf"},null,544),s("div",vi,[l(q,null,{default:p(()=>[l(E,{class:"q-pa-none"},{default:p(()=>[a.textProcess!==""?(h(),w(j,{key:0},{default:p(()=>[l(b,null,{default:p(()=>[l(V,null,{default:p(()=>[D(u(a.textProcess),1)]),_:1}),l(ne,{value:a.process,color:a.process===100?"green":"primary"},null,8,["value","color"])]),_:1}),l(b,{side:""},{default:p(()=>[l(z,{flat:"",icon:"picture_as_pdf"})]),_:1})]),_:1})):it("",!0)]),_:1})]),_:1}),(h(!0),M(et,null,tt(a.student.diagnoses,c=>(h(),w(q,{key:c.id,flat:"",bordered:"",class:"q-ma-sm"},{default:p(()=>[l(E,{class:"q-pa-none bg-grey-3"},{default:p(()=>[l(j,null,{default:p(()=>[l(b,{clickable:""},{default:p(()=>[l(V,{class:"text-bold"},{default:p(()=>[D(u(e.$filters.formatdMY(c.created_at))+" ",1),l(z,{flat:"",icon:"fa-regular fa-file-pdf",dense:"",class:"q-pa-none",color:"red",size:"10px",onClick:v=>m.downloadFile(c),loading:a.loading},null,8,["onClick","loading"])]),_:2},1024),l(V,{class:"text-capitalize text-caption"},{default:p(()=>[D(u(c.name),1)]),_:2},1024)]),_:2},1024),l(b,{side:""},{default:p(()=>[l(z,{flat:"",icon:"delete",onClick:v=>m.deleteDiagnosis(c.id),color:"red",loading:a.loading},null,8,["onClick","loading"])]),_:2},1024)]),_:2},1024)]),_:2},1024)]),_:2},1024))),128))])]),_:1})]),_:1})])]),l(at,{modelValue:a.historyDialog,"onUpdate:modelValue":t[9]||(t[9]=c=>a.historyDialog=c)},{default:p(()=>[l(q,{style:{width:"400px","max-width":"90vw"}},{default:p(()=>[l(E,{class:"row items-center q-pb-none"},{default:p(()=>[s("div",Ci,u(a.history.id?"Editar":"Agregar")+" Registro Anecd\xF3tico ",1),l(H),l(z,{flat:"",icon:"close",onClick:t[6]||(t[6]=c=>a.historyDialog=!1)})]),_:1}),l(E,null,{default:p(()=>[l(ht,{class:"q-gutter-md",onSubmit:m.historyForm},{default:p(()=>[l(te,{type:"textarea",modelValue:a.history.description,"onUpdate:modelValue":t[7]||(t[7]=c=>a.history.description=c),label:"Descripci\xF3n",outlined:"",rules:[c=>!!c||"Campo requerido"]},null,8,["modelValue","rules"]),l(ut,{align:"right"},{default:p(()=>[l(z,{label:"Cancelar",color:"red",onClick:t[8]||(t[8]=c=>a.historyDialog=!1),"no-caps":"",icon:"close",loading:a.loading},null,8,["loading"]),a.history.id===void 0?(h(),w(z,{key:0,label:"Guardar",color:"green",type:"submit","no-caps":"",icon:"save",loading:a.loading},null,8,["loading"])):(h(),w(z,{key:1,label:"Modificar",color:"orange",type:"submit","no-caps":"",icon:"save",loading:a.loading},null,8,["loading"]))]),_:1})]),_:1},8,["onSubmit"])]),_:1})]),_:1})]),_:1},8,["modelValue"])]),_:1})}var Pi=gt(je,[["render",zi]]);export{Pi as default};
